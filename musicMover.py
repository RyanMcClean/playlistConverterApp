...
def musicCopy(musicLoc, musicMoveLoc):
    ...
    if not os.path.exists(musicLoc):
        ...
        output = subprocess.Popen("sudo mount.cifs //RyansLaptop/c/ /mnt/windows-share/ "
                                      "-o user=ryan1328@hotmail.com,pass=A9450CBBAA9EF6E8666B66FCFDCA145A084ADC00F1B1FE2C7EB8E63625640157,ip=192.168.50.187 >/dev/null 2>&1",
